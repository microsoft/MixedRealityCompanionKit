...
namespace SpectatorView
{
    ...
    public class BuildDeployWindow : EditorWindow
    {
        ...
        private bool LocalIPsOnly { get { return false; } }
        ...
        public static BuildDeployWindow GetBuildWindow()
        {
            return GetWindow<BuildDeployWindow>("Build Window") as BuildDeployWindow;
        }
        ...
        public void BuildAndRun(string appName)
        {
            // First build SLN
        ...
        public void LaunchAppOnIPs(string targetIPs)
        {
            string packageFamilyName = CalcPackageFamilyName();
            if (string.IsNullOrEmpty(packageFamilyName))
            {
