...
namespace SimpleSharing
{
    ...
    /// </summary>
    public class AnchorNetworkTransmitter : SimpleSharing.Singleton<AnchorNetworkTransmitter>
    {
        ...
        public void ConfigureAsServer()
        {
            ...
            Debug.Log(string.Format("AnchorOwnerIP = {0} waitingForConnection = {1} mostRecentDataBuffer = {2}", AnchorOwnerIP, waitingForConnection, mostRecentDataBuffer == null ? "No there" : "there"));
        }
