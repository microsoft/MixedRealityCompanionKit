...
{
    class SpectatorViewPoseProviderMain : public DX::IDeviceNotify
    {
    public:
        SpectatorViewPoseProviderMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~SpectatorViewPoseProviderMain();
