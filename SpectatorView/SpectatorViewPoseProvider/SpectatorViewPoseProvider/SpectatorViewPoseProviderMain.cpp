...
#include "pch.h"
#include "SpectatorViewPoseProviderMain.h"
...
SpectatorViewPoseProviderMain::SpectatorViewPoseProviderMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
    ...
    m_locatabilityChangedToken =
        m_locator->LocatabilityChanged +=
            ref new Windows::Foundation::TypedEventHandler<SpatialLocator^, Object^>(
                std::bind(&SpectatorViewPoseProviderMain::OnLocatabilityChanged, this, _1, _2)
                );
    ...
    m_cameraAddedToken =
        m_holographicSpace->CameraAdded +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraAddedEventArgs^>(
                std::bind(&SpectatorViewPoseProviderMain::OnCameraAdded, this, _1, _2)
                );
    ...
    m_cameraRemovedToken =
        m_holographicSpace->CameraRemoved +=
            ref new Windows::Foundation::TypedEventHandler<HolographicSpace^, HolographicSpaceCameraRemovedEventArgs^>(
                std::bind(&SpectatorViewPoseProviderMain::OnCameraRemoved, this, _1, _2)
                );
...
bool SpectatorViewPoseProviderMain::Render(Windows::Graphics::Holographic::HolographicFrame^ holographicFrame)
{
...
void SpectatorViewPoseProviderMain::SaveAppState()
{
    //
...
void SpectatorViewPoseProviderMain::LoadAppState()
{
    //
...
void SpectatorViewPoseProviderMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void SpectatorViewPoseProviderMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void SpectatorViewPoseProviderMain::OnCameraAdded(
...
void SpectatorViewPoseProviderMain::OnCameraRemoved(
    HolographicSpace^ sender,
