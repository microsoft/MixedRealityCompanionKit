...
enum UnityRenderingExtTextureFormat
{
    ...
    kUnityRenderingExtFormatRGB_ATC_UNorm, kUnityRenderingExtFormatATCFirst = kUnityRenderingExtFormatRGB_ATC_UNorm,
    kUnityRenderingExtFormatRGBA_ATC_UNorm, kUnityRenderingExtFormatATCLast = kUnityRenderingExtFormatRGBA_ATC_UNorm,
