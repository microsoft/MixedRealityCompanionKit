...
namespace Persistence
{
    public class ZoneCalibrationManager : MonoBehaviour
    {
        ...
        public bool IsCalibrating { get { return currentZone != null; } }
        ...
        public void AlignZone(int whichZoneIndex = 0)
        {
        ...
        public void LockZone(bool placeAnchor)
        {
            ...
            currentZone.LockZone(placeAnchor, placeAnchor);
            ToggleOverlay(false);
        }
    }
}