...
#pragma pack(pop)
        ...
        */
        ...
        extern "C" typedef void(__stdcall *StateChangedCallback)(_In_ PLAYBACK_STATE args);
        ...
        private:
            ...
            com_ptr<Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface> m_primaryMediaSurface;
        };
