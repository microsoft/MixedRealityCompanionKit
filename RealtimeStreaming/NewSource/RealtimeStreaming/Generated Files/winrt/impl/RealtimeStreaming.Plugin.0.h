...
template <> struct guid_storage<RealtimeStreaming::Plugin::IModule>{ static constexpr guid value{ 0x2EDEB3FB,0x8008,0x4A13,{ 0xB8,0xD3,0x70,0x81,0xFD,0x11,0x44,0x3F } }; };
template <> struct guid_storage<RealtimeStreaming::Plugin::IModuleFactory>{ static constexpr guid value{ 0x1D81174E,0x2DC0,0x11E9,{ 0xB2,0x10,0xD6,0x63,0xBD,0x87,0x3D,0x93 } }; };
