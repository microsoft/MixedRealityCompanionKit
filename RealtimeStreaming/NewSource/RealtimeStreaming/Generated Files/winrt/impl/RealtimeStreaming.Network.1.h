...
struct WINRT_EBO IBundleReceivedArgs :
    Windows::Foundation::IInspectable,
    impl::consume_t<IBundleReceivedArgs>
{
    IBundleReceivedArgs(std::nullptr_t = nullptr) noexcept {}
};

struct WINRT_EBO IBundleReceivedArgsFactory :
    Windows::Foundation::IInspectable,
    impl::consume_t<IBundleReceivedArgsFactory>
{
    IBundleReceivedArgsFactory(std::nullptr_t = nullptr) noexcept {}
};
