...
struct WINRT_EBO RealtimeServerT : implements<D, Windows::Foundation::IActivationFactory, RealtimeStreaming::Media::IRealtimeServerFactory, I...>
{
    ...
    RealtimeStreaming::Media::RealtimeServer CreateInstance(RealtimeStreaming::Network::Connection const& connection, GUID const& inputMediaType, Windows::Media::MediaProperties::MediaEncodingProfile const& mediaEncodingProperties)
    {
