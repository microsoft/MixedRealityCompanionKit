...
namespace winrt::RealtimeStreaming::Media::implementation
{
    struct RealtimeServer : RealtimeServerT<RealtimeServer, RealtimeStreaming::Plugin::implementation::Module>
    {
        ...
        RealtimeServer(RealtimeStreaming::Network::Connection const& connection, GUID const& inputMediaType, Windows::Media::MediaProperties::MediaEncodingProfile const& mediaEncodingProperties);
