...
namespace MixedRemoteViewCompositor
{
	namespace Media
	{
		...
		//DECLARE_INTERFACE_IID_(IStreamingMediaSource, IUnknown, "dc70dfca-89ab-46b0-aae0-77b0c16b6944")
		DECLARE_INTERFACE_IID_(IStreamingMediaSource, IUnknown, "1afaad8b-b15a-4944-aa06-e16a511199b2")
		{
			STDMETHOD(get_MediaStreamSource)(_COM_Outptr_ ABI::Windows::Media::Core::IMediaStreamSource** ppMediaStreamSource) PURE;
		};

		class StreamingMediaSourceImpl
			: public Microsoft::WRL::RuntimeClass
			//< Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>
			<RuntimeClassFlags<RuntimeClassType::WinRtClassicComMix>
			, IStreamingMediaSource
		...
		public:
			// Contructor
			StreamingMediaSourceImpl();
			virtual ~StreamingMediaSourceImpl();
		...
		private:
			...
			ComPtr<IMediaEncodingProfile> m_spMediaEncodingProfile;
