...
namespace LiveStreaming
{
    ...
    public class StreamVideoPlayer_V2 : MonoBehaviour
    {
        ...
        public void Shutdown()
        {
            ...
            {
                PlayerPlugin.ReleaseMediaPlayback();
        ...
        private void CreateRealTimePlayer()
        {
            ...
            CheckHR(PlayerPlugin.CreateMediaPlayback(this.networkConnection.Handle,
                this.stateCallback,
                this.createdHandler,
                thisObjectPtr
                ));
        ...
        public void Pause()
        {
            CheckHR(PlayerPlugin.Pause());
        }

        public void Stop()
        {
            CheckHR(PlayerPlugin.Stop());
        }
        ...
        private static class PlayerPlugin
        {
            ...
            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "CreateStreamingPlayer")]
            //internal static extern long CreateMediaPlayback(StateChangedCallback callback);
            internal static extern long CreateMediaPlayback(uint connectionHandle, StateChangedCallback callback, [MarshalAs(UnmanagedType.FunctionPtr)]PluginCallbackHandler createdCallback, IntPtr objectPtr);

            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "ReleaseMediaPlayback")]
            internal static extern void ReleaseMediaPlayback();

            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "CreateStreamingTexture")]
            internal static extern long CreateStreamingTexture(UInt32 width, UInt32 height, out System.IntPtr playbackTexture);


            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "StreamingPlay")]
            internal static extern long Play();

            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "StreamingPause")]
            internal static extern long Pause();

            [DllImport("MixedRemoteViewCompositor", CallingConvention = CallingConvention.StdCall, EntryPoint = "StreamingStop")]
        ...
        internal static class Player_PluginCallbackWrapper
        {
            ...
            {
                var thisObj = Plugin.GetSenderObject<StreamVideoPlayer_V2>(senderPtr);
